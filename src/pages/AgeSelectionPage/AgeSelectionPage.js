...
const AgeSelectionPage = ({ navigation, route }) => {
  ...
  // Generate ages 18-100 - useMemo to prevent regeneration
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Yaşınızı Seçiniz</Text>
        ...
        <View style={styles.pickerContainer}>
          ...
          <Animated.FlatList
            ...
            contentContainerStyle={{
              paddingVertical: (350 - ITEM_HEIGHT) / 2, // Center the items in the container
            }}
      ...
      {/* KVKK Message - Simplified for now */}
      {showKVKKMessage && (
...
const styles = StyleSheet.create({
  ...
  centerLine: {
    ...
    right: '20%',
    height: 1,
    backgroundColor: 'transparent', // We don't need a visible line based on design, but can add if needed
    zIndex: -1,
  },
  flatList: {
    flexGrow: 0,
